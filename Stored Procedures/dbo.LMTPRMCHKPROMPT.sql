...
SET ANSI_NULLS ON
GO
create procedure [dbo].[LMTPRMCHKPROMPT](
  @p_num varchar(14),
  @p_title varchar(200),
  @p_Event varchar(100)
)as
begin
  ...
  --模块参数    
  select @usergid=CHECKER from LMTPRM where NUM=@p_num
  ...
  execute PFA_SERIALIZEXML_SETSTRING 'procName', 'MsgShowPrcLmtPrm', @xml_procName output
  ...
  execute PFA_MscbNotify_AppendNotify 'PS3_HDBasic_PrcLmtPrmDetail', @p_event, @xml_map_dict, @xml_map_prompt, @applydate, @usergid, @usercode, @username, @return output
end
GO
