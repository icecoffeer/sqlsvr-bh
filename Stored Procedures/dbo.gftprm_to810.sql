...
SET ANSI_NULLS ON
GO
create procedure [dbo].[gftprm_to810]
(
  @piNum	char(14),
  @piOper char(30),
...
begin
  ...
  if (@stat <> 800) and (@stat <> 1400)
  begin
    set @poErrMsg = @piNum + '不是已生效单据，不能生效后作废'
    return 1
  end
  ...
  update gftprm set stat = 810, lstupdtime = getdate() where num = @piNum;
  exec gftprm_addlog @piNum, 810,@piOper
  return 0
end
GO
