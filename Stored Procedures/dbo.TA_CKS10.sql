...
EXEC ('DECLARE CUR_GETVOUCHER CURSOR GLOBAL FOR 
	...
	CONVERT(VARCHAR(100),CONVERT(DEC(20,2),sum((( CKDTL.QTY -CKDTL.ACNTQTY)*CKDTL.INPRC)/(1+goodsh.taxrate/100)*goodsh.taxrate/100)/1.13))  G,
	...
	and goodsh.f1 like ''s%'' and goodsh.taxrate=10
