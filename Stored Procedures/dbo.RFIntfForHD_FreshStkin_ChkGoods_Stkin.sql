...
SET ANSI_NULLS ON
GO
create procedure [dbo].[RFIntfForHD_FreshStkin_ChkGoods_Stkin](
...
begin
  ...
  exec OPTREADINT 52, '采用一品多供应商时限制进货选择', 0, @Opt_LmtGdSel output
  ...
  begin
    ...
    else if @SingleVdr = 2 and @Opt_LmtGdSel = 1 and not exists(select 1
