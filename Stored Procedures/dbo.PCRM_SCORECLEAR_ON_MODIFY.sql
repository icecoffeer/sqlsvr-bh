...
SET ANSI_NULLS OFF
GO
create procedure [dbo].[PCRM_SCORECLEAR_ON_MODIFY] (
  @piNum char(14),                     --单号
  @piOperGid int,                      --操作人
  @piToStat int,                       --目标状态
...
begin
  ...
  begin
    exec @vRet = PCRM_SCORECLEAR_STAT_TO_100 @piNum, @piOperGid, @poErrMsg output
    return(@vRet)
  end
  ...
  update CRMSCORECLEAR set 
    ...
    LSTUPDTIME = getdate()
  where NUM = @piNum
  exec PCRM_SCORECLEAR_ADD_LOG @piNum, @vStat, @piToStat, @piOperGid
