...
EXEC ('DECLARE CUR_GETVOUCHER CURSOR GLOBAL FOR 
	SELECT STORE.CODE A,
        STORE.NAME B,
        ''部门'' C,
	CONVERT(VARCHAR(100),CONVERT(DEC(20,2),SUM((OUTDRPT.DI1-OUTDRPT.DI5)/(1+ GOODSH.SALETAX/100)))) D,
	CONVERT(VARCHAR(100),SUM(OUTDRPT.DI1-OUTDRPT.DI5)-CONVERT(DEC(20,2),SUM((OUTDRPT.DI1-OUTDRPT.DI5)/(1+ GOODSH.SALETAX/100)))) E, 
	CONVERT(VARCHAR(100),SUM(OUTDRPT.DI1-OUTDRPT.DI5)) F,
