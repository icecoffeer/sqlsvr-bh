CREATE TABLE [dbo].[VOUCHERUSERULERANGEOUTDTLOCR]
(
...
GO
ALTER TABLE [dbo].[VOUCHERUSERULERANGEOUTDTLOCR] ADD CONSTRAINT [PK__VOUCHERUSERULERA__44AA6DA9] PRIMARY KEY CLUSTERED  ([BILLNUM], [BILLLINE]) ON [PRIMARY]
GO
