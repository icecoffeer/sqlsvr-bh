CREATE TABLE [dbo].[sgUploadFailureRecord]
(
...
GO
ALTER TABLE [dbo].[sgUploadFailureRecord] ADD CONSTRAINT [PK__sgUpload__7F4279306383FA84] PRIMARY KEY CLUSTERED  ([uuid]) ON [PRIMARY]
GO
